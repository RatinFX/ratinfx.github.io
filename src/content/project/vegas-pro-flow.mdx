...
- Toggle options in the **Settings** menu such as:
  ...
  - **Ignore long section warning** - skip the warning on animating longer than 120 frame sections
  - **Snap Keyframes to whole Frames** - create keyframes on the nearest frame instead of having them evenly spacing
